    ...
    <>
      ...
      >
        <div
          ...
          className="relative left-[calc(50%+3rem)] aspect-1155/674 w-144.5 -translate-x-1/2 bg-linear-to-tr from-[#fab834] to-[#885b00] opacity-30 sm:left-[calc(50%+36rem)] sm:w-288.75"
        />
      </div>
    </>
