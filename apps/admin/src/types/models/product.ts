...
export interface CreateProductData {
  ...
  image_url?: string;
  sku?: string;
  shop?: string | number; // Nombre de la tienda (slug_field="name") o pk (id) para creación/edición
  description?: string;
  category?: string | number; // Nombre de la categoría o pk (id) para creación/edición
  amount_requested: number;
