              ...
              <MobileDataCard
                ...
                title={
                  <div className="flex items-center gap-2">
                    <Avatar className="h-7 w-7">
                      <AvatarFallback className="bg-gradient-to-br from-orange-400 to-yellow-200 font-semibold text-xs">
                        {user.name.charAt(0)}
                ...
                badges={
                  <>
                    ...
                    {user.is_verified ? (
                      <Badge className="rounded-full px-2 py-0.5 bg-green-100 text-green-700 flex items-center gap-1 text-xs">
                        <CheckCircle className="h-3 w-3" />
                        Verificado
                      </Badge>
                    ) : (
                      <Badge className="rounded-full px-2 py-0.5 bg-yellow-100 text-yellow-700 flex items-center gap-1 text-xs">
                        <Clock className="h-3 w-3" />
                        Sin verificar
                      </Badge>
                    )}
                    {user.is_active ? (
                      <Badge className="rounded-full px-2 py-0.5 bg-blue-100 text-blue-700 flex items-center gap-1 text-xs">
                        <CheckCircle className="h-3 w-3" />
                        Activo
                      </Badge>
                    ) : (
                      <Badge className="rounded-full px-2 py-0.5 bg-gray-100 text-gray-600 flex items-center gap-1 text-xs">
                ...
                rows={[
                  {
                    icon: Mail,
                    label: "Email",
                    value: user.email || <span className="text-gray-400 italic">Sin email</span>,
                  },
                  ...(user.agent_name
                    ? [
                        {
