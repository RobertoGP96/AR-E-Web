...
import { Plus, Minus, ShoppingCart, Trash2, Package, Search, Box, ShoppingBag } from "lucide-react"
...
import type { CreateProductBuyedData, Product, ProductBuyed } from "@/types/models"
...
interface ProductSelectorProps {
    ...
    onCartChange?: (cart: CreateProductBuyedData[], fullCartDetails?: ProductBuyed[]) => void
    showSummary?: boolean
    maxHeight?: string
}
...
const filteredProducts = useMemo(() => {
    return products.filter((product) => {
        ...
        if (shopFilter && product.shop.toLowerCase() !== shopFilter.toLowerCase()) {
            return false;
        }
    ...
    const convertCartToCreateData = (cartItems: ProductBuyed[]): CreateProductBuyedData[] => {
        ...
        <div className="grid gap-6 lg:grid-cols-2">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        ...
                        {!shopFilter && !statusFilter && "Selecciona productos para agregar a la compra"}
                    </CardDescription>
                            ...
                            {filteredProducts.length === 0 ? (
                                ...
                                filteredProducts.map((product) => {
                                    ...
                                    return (
                                        <div
                                            key={product.id}
                                            className={"flex items-center gap-4 rounded-lg border p-3 transition-colors hover:bg-muted/50 " + (cartQty > 0 ? "bg-orange-50 border-orange-200" : "")}
                                        >
                                                ...
                                                {cartQty > 0 ? (
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <Button
                                                            ...
                                                            size="icon"
                                                            className="h-8 w-8"
                                                            disabled={cartQty >= (product.amount_requested - product.amount_purchased)} 
                                                            onClick={() => updateQuantity(product.id, 1)}
                                                        >
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Productos seleccionados para tu compra</CardDescription>
                </CardHeader>
                <CardContent>
                    <ScrollArea className="pr-4" style={{ height: maxHeight }}>
                        {cart.length === 0 ? (
                    ...
                    <CardFooter className="flex-col items-start gap-2 border-t pt-4">
                        <div className="w-full space-y-1">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium">{cartSummary.totalItems} unidades</span>
                            </div>
