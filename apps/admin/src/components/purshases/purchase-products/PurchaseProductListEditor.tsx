    ...
    <div className="w-full space-y-4">
      <div className="flex flex-row items-center justify-between px-1">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold tracking-tight text-slate-900 line-clamp-1">
        ...
        {onAddClick && (
          <Button
            ...
            className="rounded-full px-4 border-slate-200 hover:bg-orange-50 hover:text-orange-600 transition-all duration-200"
          >
