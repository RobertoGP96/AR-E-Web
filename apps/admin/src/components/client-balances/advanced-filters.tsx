                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (value <= filters.balanceRange[1]) {
                        updateFilter("balanceRange", [
                          value,
                          filters.balanceRange[1],
                        ]);
                      }
                    }}
                    min={balanceMin}
            ...
            <div className="p-4 border-t bg-muted/30">
              <div className="flex flex-wrap gap-2">
                ...
                {(filters.balanceRange[0] !== balanceMin ||
                  filters.balanceRange[1] !== balanceMax) && (
                  <Badge variant="secondary" className="gap-1 pr-1">
                    {formatCurrency(filters.balanceRange[0])} -{" "}
                    {formatCurrency(filters.balanceRange[1])}
                    <button
                      onClick={() =>
                        updateFilter("balanceRange", [balanceMin, balanceMax])
                      }
                      className="ml-1 rounded-full hover:bg-muted p-0.5"
                    >
                      <X className="h-3 w-3" />
