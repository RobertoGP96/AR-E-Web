...
export function ExpencesForm({
  ...
  const onFormSubmit: SubmitHandler<
    CreateExpenseFormData | EditExpenseFormData
  > = async (data) => {
    try {
      const submitData =
        mode === "create"
      ...
      <FieldGroup>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <Field>
              ...
              <Select
                ...
                onValueChange={(val) =>
                  setValue("category" as const, val as ExpenseCategory, {
                    shouldDirty: true,
                    shouldValidate: true,
                  })
                }
              >
                <SelectTrigger
                  className={`h-10 ${errors.category ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-orange-200 focus:border-orange-400"}`}
                >
            ...
            <Field>
              ...
              <InputGroup>
                <InputGroupInput
                  ...
                  className={`h-10 ${errors.amount ? "border-red-500" : "border-gray-300"}`}
                />
        ...
        <Field orientation="horizontal" className="justify-end space-x-2 ">
          ...
          <Button type="submit" disabled={loading}>
            ...
            <p>{mode === "create" ? "Crear Gasto" : "Actualizar Gasto"}</p>
          </Button>
        </Field>
      </FieldGroup>
    </form>
