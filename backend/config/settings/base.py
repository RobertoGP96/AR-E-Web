...
# Railway healthcheck uses this host header — must be allowed in all environments
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 1000,  # Default para obtener todos si no se especifica
...
# JWT Configuration
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=config('ACCESS_TOKEN_LIFETIME_MINUTES', default=120, cast=int)),
